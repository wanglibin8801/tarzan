...
import com.tarzan.common.mybatis.MyBatisParameterNameDiscoverer;
import com.tarzan.common.mybatis.annotation.CryptField;
import com.tarzan.common.mybatis.util.CryptContextUtils;
import com.tarzan.common.mybatis.util.CryptLoaderUtils;
...
public class CryptPlugin implements Interceptor {
    ...
    private String stringEncrypt(String plain, CryptField cryptField) {
        ...
        return CryptContextUtils.getCrypt(cryptField.value()).encrypt(plain);
    }
    ...
    private String stringDecrypt(String cipher, CryptField cryptField) {
        ...
        return CryptContextUtils.getCrypt(cryptField.value()).decrypt(cipher);
    }
